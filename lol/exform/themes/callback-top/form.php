...
<div class="exform_wrapper callback-top">
 ...
 <form name="exform">
  <div class="inpt_wrpr">
   ...
   <input type="text" name="mf_phone_time" value="" class="<?php echo $field_class["phone_time"];?>" placeholder="<?php echo $config->phone_time_title;?>" />
